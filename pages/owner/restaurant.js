      ...
      <div>
        <div className="row">
          <div className="column">
            <h1 onClick={() => router.push("/owner")}>Touch&nbsp;</h1>
            <h1 style={{ color: "grey" }}>{router.query.name}</h1>
          </div>
          <div className="column">
        ...
        <div className="row">
          ...
          <div className="column">
            ...
            >
              <span onClick={toggle2} className="closebtn">
                &times;
              </span>
              <h2>Carta</h2>
              <p>
                Lorem ipsum dolor sit amet, te quo doctus abhorreant, et pri
                deleniti intellegat, te sanctus inermis ullamcorper nam. Ius
                error diceret deseruisse ad
              </p>
            </div>
            <div
              id="team"
